...
public void AtualizarTable_Pesquisar_Nome() {
        ...
        lista = bd.Pesquisar_Cod_Aluguel(Nome);
        ...
        for (Aluguel tab : lista) {
            ...
            jTable1.setValueAt(tab.getCodequipamento(), i, 0);
            jTable1.setValueAt(tab.getCodlocal(), i, 1);
            jTable1.setValueAt(tab.getAula(), i, 2);
            jTable1.setValueAt(tab.getCodprofessor(), i, 3);
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(110, 260, 100, 40);
        ...
        jButton2.setBounds(240, 260, 100, 40);

        jLabel5.setText("Pesquise por um dos conteúdos abaixo :");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(10, 30, 210, 20);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "professor(a)", "local", "equipamrnto", "aula(s)"
            }
        ));
        ...
        jTextField1.setBounds(230, 30, 160, 20);
